...
export default function Register() {
  ...
  const onSubmit = handleSubmit(async (values) => {
    // Asumiendo que tu backend espera email, password y role
    const userData = {
      email: values.email,
  ...
  return (
    ...
    <h2 className='text-3xl w-80 sm:w-[40rem] xl:w-full sm:text-4xl text-center mx-auto'>Gestión de Bases de Datos Aerolinea</h2>
      <div className="mx-auto pt-10 w-full sm:w-[30rem] rounded-md">
        ...
        <h1 className="text-3xl text-center font-bold my-4">Registrate</h1>
